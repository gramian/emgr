function W = emgr(f,g,s,t,w,pr=0.0,nf=0,ut=1.0,us=0.0,xs=0.0,um=1.0,xm=1.0,yd=0)
...
## GRAMIAN COMPUTATION
    ...
    switch(w) # by empirical gramian types
        ...
        case 'i', # identifiability gramian
            ...
            if(nf(10))
                W{2} -= V(N+1:N+P,1:N)*fastinv(W{1})*V(1:N,N+1:N+P);
            end;
