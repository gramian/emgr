...
# Further information: https://gramian.de
    ...
    # Version Info
    if(strcmp(f,'version')), W = 5.5; return; endif
...
## GENERAL SETUP
    ...
    if(isscalar(xm)), xm = xm * ones(N-((w=='y')*(N-M)),1); endif
            ...
            for k = 1:K
                for d = 1:D
                    for n = find(xm(:,d))' # parfor
                        ...
                        y -= avg(y,nf(1),g(xs(1:N),us,pk,0),t);
                        y /= xm(n,d);
                        o(:,n) = y(:);
                    endfor;
                    W += dp(o',o);
